...
/*
      // code to retrieve properties of fission fragments
      ...
      double KE_ff = 0;
      double dir_ff[3];
      double preEvapExcEnergy_ff = 0;
      double postEvapExcEnergy_ff = 0;
      getfission_fragment_(ff_index, &A_ff, &Z_ff, &KE_ff, dir_ff,
                           &preEvapExcEnergy_ff, &postEvapExcEnergy_ff);
      printf("%i.%i KE: %f MeV (%f,%f,%f) Epre: %f MeV Epost: %f MeV\n",Z_ff,A_ff,KE_ff,dir_ff[0],dir_ff[1],dir_ff[2],preEvapExcEnergy_ff,postEvapExcEnergy_ff);
 */
